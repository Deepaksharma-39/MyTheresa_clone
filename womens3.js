let clothData = [
    {
        img: "https://img.mytheresa.com/560/560/33/jpeg/catalog/product/6b/P00703630_b1.jpg",
        name: "ETRO",
    ...
    {
        img: "https://img.mytheresa.com/560/560/33/jpeg/catalog/product/83/P00686589_d2.jpg",
        name: "LOEWE",
    ...
    {
        img: "https://img.mytheresa.com/560/560/33/jpeg/catalog/product/00/P00686588_d2.jpg",
        name: "LOEWE",
    ...
    {
        img: "https://img.mytheresa.com/560/560/33/jpeg/catalog/product/f8/P00704500_b1.jpg",
        name: "STELLA MCCARTNEY",
...
let cladata = JSON.parse(localStorage.getItem("womens-cloth")) || []
    ...
    clothData.forEach(function (el) {
        ...
        wish.addEventListener("click", function () {
            if (toggle(el, wish) == true) {
                ...
                cladata.push(el)
                alert("added")
                localStorage.setItem("womens-cloth", JSON.stringify(cladata))
            }
        })
        // console.log("Sanjay")
        holder.append(wish)
